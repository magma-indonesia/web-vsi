    ...
    <div class="container">
        <div class="sab_banner_text">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('press-release.index') }}">Press Release Gunung
                        Api</a></li>
            </ul>
        </div>
    </div>
...
<div class="city_blog2_wrap team" style="background: #f0f2f7">
    <div class="container">
        <div id="app">
            <news 
                apiurl="{{ route('press-release.get') }}" 
                detailurl="{{ route('press-release.detail', '') }}" 
            ></news>
        </div>
    </div>
</div>
