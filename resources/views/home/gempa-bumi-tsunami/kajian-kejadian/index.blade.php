    ...
    <div class="container">
        <div class="sab_banner_text">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('gempa-bumi-tsunami.kajian-kejadian') }}">Kajian Kejadian Gempa Bumi & Tsunami</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="city_blog2_wrap team" style="background: #fff">
    <div class="container">
        <div id="app">
            <news apiurl="{{ env('APP_URL') }}" category="5"></news>
        </div>
    </div>
</div>
@endsection
