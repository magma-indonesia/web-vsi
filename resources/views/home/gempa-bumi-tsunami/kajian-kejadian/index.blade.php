    ...
    <div class="container">
        <div class="sab_banner_text">
            ...
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="{{ route('gempa-bumi-tsunami.kajian-kejadian.index') }}">Kajian Kejadian Gempa Bumi & Tsunami</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="city_blog2_wrap team" style="background: #f0f2f7">
    <div class="container">
        <div id="app">
            <news 
                apiurl="{{ route('gempa-bumi-tsunami.kajian-kejadian.get') }}" 
                detailurl="{{ route('gempa-bumi-tsunami.kajian-kejadian.detail', '') }}" 
            ></news>
        </div>
    </div>
</div>
