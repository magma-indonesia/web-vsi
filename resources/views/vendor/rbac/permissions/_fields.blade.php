    ...
    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
        <div class="form-group">
            ...
            <input id="permission_name" type="text" class="form-control @if ($errors->has('name')) is-invalid @endif"
                   name="name" value="{{ old('name', isset($permission) ? $permission->name : null) }}" required
                   autofocus>
            @if ($errors->has('name'))
    ...
    <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
        <div class="form-group">
            ...
            <input id="permission_description" type="text"
                   ...
                   name="description"
                   value="{{ old('description', isset($permission) ? $permission->description : null) }}" required
                   autofocus>
...
@if($edit)
    <div class="row">
        <div class="col-12 col-sm-10 col-md-8 col-lg-6 col-xl-4">
            <div class="form-group">
                <label for="permission_slug">{!! __('rbac::main.slug') !!}
                    ({!! __('rbac::main.generated_automatically') !!})</label>
