<div class="wrapper">
    ...
    <div class="city_main_banner">
        <div class="main-banner-slider">
            ...
            <div>
                <figure class="overlay">
                    <img src="extra-images/main-banner1.jpg" alt="">
                    <div class="banner_text">
                        <div class="small_text animated">Welcome to</div>
                        <div class="medium_text animated">Smart City</div>
            ...
            <div>
                <figure class="overlay">
                    <img src="extra-images/main-banner2.jpg" alt="">
                    <div class="banner_text">
                        <div class="small_text animated">Welcome to</div>
                        <div class="medium_text animated">Smart City</div>
                        <div class="large_text animated">municipal</div>
                        ...
                        <div class="city_about_video">
                            <figure class="overlay">
                                ...
                                <a class="paly_btn hvr-pulse" data-rel="prettyPhoto"
                                    href="https://www.youtube.com/watch?v=SAaevusBnNI"><i
                ...
                <div class="col-md-6">
                    <div class="city_about_list">
                        ...
                        <div class="city_about_text">
                            <h6>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.
                                Aenean sollicitudin</h6>
                        ...
                        <div class="width_control">
                            <div class="city_department_fig">
                                <figure class="box">
                                    ...
                                    <a class="paly_btn" data-rel="prettyPhoto" href="extra-images/department-fig.jpg"><i
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="city_blog_fig">
                        ...
                        <div class="city_blog_text">
                            ...
                            <p>This is Photoshop's version of Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet.
                                Aenean sollicitudin, lorem quis bibendum auctornisi elit.</p>
                    ...
                    <div class="city_project_fig">
                        <figure class="overlay">
                            ...
                            <div class="city_project_text">
                                ...
                                <h3><a href="#">Government vows to prioritize local contractors in infrastructure
                                        program</a></h3>
                            </div>
                        </figure>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="city_event_fig">
                            <figure class="box">
                                ...
                                <a class="paly_btn" data-rel="prettyPhoto" href="extra-images/event-fig.jpg"
                                    tabindex="-1"><i class="fa fa-plus"></i></a>
                            </figure>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="city_event_fig">
                            <figure class="box">
                                ...
                                <a class="paly_btn" data-rel="prettyPhoto" href="extra-images/event-fig1.jpg"
                                    tabindex="-1"><i class="fa fa-plus"></i></a>
                            </figure>
                            <div class="city_event_text">
                                <div class="city_event_history">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="city_event_fig">
                            <figure class="box">
                                ...
                                <a class="paly_btn" data-rel="prettyPhoto" href="extra-images/event-fig2.jpg"
                                    tabindex="-1"><i class="fa fa-plus"></i></a>
                            </figure>
                            <div class="city_event_text">
                                <div class="city_event_history">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="city_event_fig">
                            <figure class="box">
                                ...
                                <a class="paly_btn" data-rel="prettyPhoto" href="extra-images/event-fig3"
                                    tabindex="-1"><i class="fa fa-plus"></i></a>
                            </figure>
                            <div class="city_event_text">
                                <div class="city_event_history">
                            ...
                            <div class="city_news_fig">
                                ...
                                <div class="city_news_text">
                                    ...
                                    <p>Lorem Ipsum. Proin gravida nibh vel velit auctor aliquet. Aenean sollicitudin,
                                        lorem quis bibendum auctor, nisi elit consequat ipsum, nec sollicitudin</p>
                                    <a class="theam_btn border-color color" href="#" tabindex="0">Read More</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="widget_copyright">
                        ...
                        <div class="col-md-6">
                            <div class="copyright_text">
                                <p><span>Copyright © 2018 - 19 The Local City Municipal.</span> Designed and Developed
                                    by kodeforest</p>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
