...
@section('title', 'Edit publikasi mitigasi')
...
<div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
    <div>
        ...
        <h4 class="mg-b-0 tx-spacing--1">Edit Publikasi Mitigasi</h4>
    </div>
</div>
<div class="p-3" id="app">
    <form-news apiurl="{{ env('APP_URL') }}" category="7" backurl="{{ route('dashboard.gempa-bumi-tsunami.news') }}?category=7"
