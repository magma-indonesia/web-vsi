...
@section('body-content')
        ...
        <div>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb breadcrumb-style1 mg-b-10">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.layanan-publik.index', ['category' => $category]) }}">{{ $pageTitle }}</a></li>
    ...
    <div class="p-3" id="app">
        <form-public-service
            apiurl="{{ $appUrl }}"
            category="{{ $category }}"
            backurl="{{ route('dashboard.layanan-publik.index', ['category' => $category]) }}"
            retrieve="{{ $retrieve }}"
        ></form-public-service>
    </div>
@endsection