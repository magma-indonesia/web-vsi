...
<p class="df-lead">Kerja sama PVMBG melingkupi kerja sama di bidang bencana geologi yang meliputi kegiatan penyelidikan, pemantauan,
instalasi peralatan, dan optimalisasi sistem mitigasi bencana geologi. Kunjungi halaman <a href="{{ route('layanan-publik.kerja-sama.informasi-kerja-sama') }}"
...
<p class="mg-b-30">Pengajuan baru permohonan kerja sama di bidang kebencanaan geologi yang telah masuk dan akan diproses untuk dilakukan pengecekan syarat administrasi dan kelengkapan dokumen. Daftar ini digunakan untuk melihat berapa banyak pengajuan yang masuk dalsam satu waktu.</p>
            ...
            <ul class="list-group list-group-flush tx-13">
                <li class="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div class="pd-l-10">
                        ...
                        <small class="tx-12 tx-color-03 mg-b-0">Gunung Api - Penyelidikan Geologi, Geokimia, dan Geofisika</small>
                    </div>
                    <div class="mg-l-auto d-flex align-self-center">
                        <nav class="nav nav-icon-only">
                            <a href="" class="nav-link d-none d-sm-block"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                            ...
                            <a href="" class="nav-link d-sm-none"><svg xmlns="http://www.w3.org/2000/svg" width="24"
                                    height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="list-group-item d-flex pd-sm-x-20">
                    ...
                    <div class="pd-l-10">
                        ...
                        <small class="tx-12 tx-color-03 mg-b-0">Gempa Bumi dan Tsunami - Pemantauan Sesar Lembang</small>
                    </div>
                    <div class="mg-l-auto d-flex align-self-center">
                        <nav class="nav nav-icon-only">
                            <a href="" class="nav-link d-none d-sm-block"><svg xmlns="http://www.w3.org/2000/svg" width="24"
...
<p class="mg-b-30">Using the most basic table markup, here’s how <code>.table</code> based tables look in Bootstrap. All
