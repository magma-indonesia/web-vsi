...
<div class="row row-xs">
    <div class="col-sm-6 col-lg-3">
        <div class="card card-body">
            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Penilaian</h6>
    ...
    <div class="col-sm-6 col-lg-3 mg-t-10 mg-sm-t-0">
        <div class="card card-body">
            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Total Permintaan</h6>
            <div class="d-flex d-lg-block d-xl-flex align-items-end">
                <h3 class="tx-normal tx-rubik mg-b-0 mg-r-5 lh-1">22</h3>
    ...
    <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
        <div class="card card-body">
            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Belum Dikerjakan</h6>
            <div class="d-flex d-lg-block d-xl-flex align-items-end">
    ...
    <div class="col-sm-6 col-lg-3 mg-t-10 mg-lg-t-0">
        <div class="card card-body">
            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-8">Selesai</h6>
            <div class="d-flex d-lg-block d-xl-flex align-items-end">
        ...
        <div class="card">
            ...
            <div class="card-body pos-relative pd-0">
                <div class="pos-absolute t-20 l-20 wd-xl-100p z-index-10">
                    <div class="row">
                        <div class="col-sm-5">
                            <h3 class="tx-normal tx-rubik tx-spacing--2 mg-b-5">120</h3>
                            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-10">Total Laporan</h6>
                            <p class="mg-b-0 tx-12 tx-color-03">Total laporan yang telah diterima hingga saat ini, baik yang telah diselesaikan mauapun belum. <a href="">Detail</a></p>
                        </div><!-- col -->
                        <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                            <h3 class="tx-normal tx-rubik tx-spacing--2 mg-b-5">82</h3>
                            <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-10">Jumlah Laporan yang Diselesaikan</h6>
                            <p class="mg-b-0 tx-12 tx-color-03">Seluruh laporan yang telah diselasikan dan diberikan tanggapan kepada calon mitra. <a href="">Detail</a></p>
                        </div><!-- col -->
                    </div><!-- row -->
                </div>
    ...
    <div class="col-lg-4 col-xl-5 mg-t-10">
        <div class="card">
            <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                <h6 class="mg-b-5">Feedback dari Publik</h6>
                <p class="tx-12 tx-color-03 mg-b-0">Jumlah feedback positif dan negatif yang diberikan oleh pengunjung.</p>
            </div><!-- card-header -->
            <div class="card-body pd-20">
                ...
                <div class="row">
                    <div class="col-sm">
                        <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-5">87</h4>
                        <p class="tx-11 tx-uppercase tx-spacing-1 tx-semibold mg-b-10 tx-primary">Feedback Positif
                        </p>
                        <div class="tx-12 tx-color-03">Feedback positif yang diberikan oleh pengunjung.</div>
                    </div><!-- col -->
                    <div class="col-sm mg-t-20 mg-sm-t-0">
                        <h4 class="tx-normal tx-rubik tx-spacing--1 mg-b-5">2</h4>
                        <p class="tx-11 tx-uppercase tx-spacing-1 tx-semibold mg-b-10 tx-pink">Feedback Negatif
                        </p>
                        <div class="tx-12 tx-color-03">Feedback negatif dari pengunjung.</div>
                    </div><!-- col -->
                </div><!-- row -->
            </div><!-- card-body -->
        </div><!-- card -->
        ...
        <div class="card mg-b-10">
            <div
                ...
                <div>
                    ...
                    <p class="tx-13 tx-color-03 mg-b-0">Your sales and referral earnings over the last 30
                        days</p>
                </div>
            ...
            <div class="card-body pd-b-0">
                <div class="row mg-b-20">
                    ...
                    <div class="col">
                        ...
                        <p class="tx-10 tx-uppercase tx-spacing-1 tx-medium tx-color-03">Avg. Sales Per Day
                        </p>
                    </div>
                </div><!-- row -->
