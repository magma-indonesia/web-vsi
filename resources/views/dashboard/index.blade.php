                    ...
                    <div class="pos-absolute t-20 l-20 wd-xl-100p z-index-10">
                        <div class="row">
                            <div class="col-sm-5">
                                ...
                                <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-10">Total
                                    Laporan</h6>
                                <p class="mg-b-0 tx-12 tx-color-03">Total laporan yang telah diterima hingga saat ini,
                                    baik yang telah diselesaikan mauapun belum. <a href="">Detail</a></p>
                            </div><!-- col -->
                            <div class="col-sm-5 mg-t-20 mg-sm-t-0">
                                <h3 class="tx-normal tx-rubik tx-spacing--2 mg-b-5">82</h3>
                                <h6 class="tx-uppercase tx-11 tx-spacing-1 tx-color-02 tx-semibold mg-b-10">Jumlah
                                    Laporan yang Diselesaikan</h6>
                                <p class="mg-b-0 tx-12 tx-color-03">Seluruh laporan yang telah diselasikan dan diberikan
                                    tanggapan kepada calon mitra. <a href="">Detail</a></p>
                            </div><!-- col -->
                        </div><!-- row -->
                    </div>
        ...
        <div class="col-lg-4 col-xl-5 mg-t-10">
            <div class="card">
                <div class="card-header pd-t-20 pd-b-0 bd-b-0">
                    ...
                    <p class="tx-12 tx-color-03 mg-b-0">Jumlah feedback positif dan negatif yang diberikan oleh
                        pengunjung.</p>
                </div><!-- card-header -->
