                ...
                >
                    ...
                    >
                        ...
                        <a-popconfirm
                            ...
                            cancel-text="Tidak"
                        >
                            <a-button type="danger" key="/delete" icon="delete" title="Hapus"></a-button>
                        </a-popconfirm>
                    </div>
                </div>
            </template>
...
export default {
    ...
    methods: {
        ...
        handlePolicy(val) {
            window.location.href = this.policyurl.replace("##ID##", val.id);
        },
        handleDelete(val) {
            const postData = { id: val.id };
            axios({
                url: `${this.apiurl}/dashboard/api/role`,
                method: "DELETE",
                data: postData,
            }).then(() => {
                this.fetchData(this.params, this.pagination);
        ...
        fetchData(param = this.params, p = this.pagination) {
            this.loading = true;
            axios
                .get(`${this.apiurl}/dashboard/api/role`, {
                    params: {
                        ...param,
                        page: p.current,
                        pageSize: p.pageSize,
